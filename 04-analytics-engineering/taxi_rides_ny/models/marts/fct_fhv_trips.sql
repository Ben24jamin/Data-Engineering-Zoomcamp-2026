...
-- Fact table containing all fhv data enriched with zone information
-- This is a classic star schema design: fact table (trips) with join to table (zones)
...
from {{ ref('int_fhv_trips') }} as trips
